...
users_unit = input('What unit of measurement would you like converted into meters? (ft, mi, m, km)')
users_num = int(input(f'How many {users_unit}s would you like converted into meters? '))
